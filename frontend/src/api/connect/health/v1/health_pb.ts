...
// @generated from file connect/health/v1/health.proto (package connect.health.v1, syntax proto3)
/* eslint-disable */
/* @ts-nocheck */
 ...
 * チェックリクエスト
 *
 * @generated from message connect.health.v1.CheckRequest
 */
export class CheckRequest extends Message<CheckRequest> {
  ...
  static readonly typeName = "connect.health.v1.CheckRequest";
 ...
 * チェックレスポンス
 *
 * @generated from message connect.health.v1.CheckResponse
 */
export class CheckResponse extends Message<CheckResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "connect.health.v1.CheckResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
