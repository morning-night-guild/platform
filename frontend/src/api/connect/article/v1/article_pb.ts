...
// @generated from file connect/article/v1/article.proto (package article.v1, syntax proto3)
/* eslint-disable */
/* @ts-nocheck */
 ...
 * 共有リクエスト
 *
 * @generated from message article.v1.ShareRequest
 */
 ...
 * 一覧リクエスト
 *
 * @generated from message article.v1.ListRequest
 */
export class ListRequest extends Message<ListRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "article.v1.ListRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * 一覧レスポンス
 *
 * @generated from message article.v1.ListResponse
 */
export class ListResponse extends Message<ListResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "article.v1.ListResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
