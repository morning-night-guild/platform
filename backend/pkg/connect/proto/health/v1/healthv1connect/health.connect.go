...
import (
	...
	v1 "github.com/morning-night-guild/platform/pkg/connect/proto/health/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HealthServiceName = "proto.health.v1.HealthService"
)
...
// NewHealthServiceClient constructs a client for the proto.health.v1.HealthService service. By
...
func NewHealthServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) HealthServiceClient {
	...
	return &healthServiceClient{
		check: connect_go.NewClient[v1.CheckRequest, v1.CheckResponse](
			httpClient,
			baseURL+"/proto.health.v1.HealthService/Check",
			opts...,
		),
	}
}
...
// Check calls proto.health.v1.HealthService.Check.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/proto.health.v1.HealthService/Check", connect_go.NewUnaryHandler(
		"/proto.health.v1.HealthService/Check",
		svc.Check,
		opts...,
	))
	return "/proto.health.v1.HealthService/", mux
}
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect_go.Request[v1.CheckRequest]) (*connect_go.Response[v1.CheckResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("proto.health.v1.HealthService.Check is not implemented"))
}
