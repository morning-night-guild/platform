...
import (
	...
	v1 "github.com/morning-night-guild/platform/pkg/connect/health/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HealthServiceName = "connect.health.v1.HealthService"
)

// HealthServiceClient is a client for the connect.health.v1.HealthService service.
...
// NewHealthServiceClient constructs a client for the connect.health.v1.HealthService service. By
...
func NewHealthServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) HealthServiceClient {
	...
	return &healthServiceClient{
		check: connect_go.NewClient[v1.CheckRequest, v1.CheckResponse](
			httpClient,
			baseURL+"/connect.health.v1.HealthService/Check",
			opts...,
		),
	}
}
...
// Check calls connect.health.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the connect.health.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/connect.health.v1.HealthService/Check", connect_go.NewUnaryHandler(
		"/connect.health.v1.HealthService/Check",
		svc.Check,
		opts...,
	))
	return "/connect.health.v1.HealthService/", mux
}
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect_go.Request[v1.CheckRequest]) (*connect_go.Response[v1.CheckResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.health.v1.HealthService.Check is not implemented"))
}
